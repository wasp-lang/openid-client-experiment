...
export function getProviders() {
    ...
    registerProvider("microsoft", {
        type: "oidc",
        name: "Microsoft",
        issuer: env.AUTH_MICROSOFT_ISSUER_URL,
    ...
    registerProvider("twitch", {
        ...
        clientId: env.AUTH_TWITCH_CLIENT_ID,
        clientSecret: env.AUTH_TWITCH_CLIENT_SECRET,
    ...
    registerProvider("notion", {
        ...
        clientId: env.AUTH_NOTION_CLIENT_ID,
        clientSecret: env.AUTH_NOTION_CLIENT_SECRET,
        scope: "basic_read"
    });
    ...
    registerProvider("zoom", {
        ...
        clientId: env.AUTH_ZOOM_CLIENT_ID,
        clientSecret: env.AUTH_ZOOM_CLIENT_SECRET,
        scope: "user:read"
    });
